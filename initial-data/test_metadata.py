...
psoc = [PointOfContact(None,u"missing@name.com"),PointOfContact("non-unicode name","non-unicode-non-email"),PointOfContact(u"correct name",u"non-email"),PointOfContact(u"correct name",u"correct@email.com")]
