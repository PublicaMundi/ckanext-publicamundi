...
'Date types el' : {
                    "creation":"Ημερομηνία δημιουργίας",
                    "publication":"Ημερομηνία δημοσίευσης",
                    "revision":"Ημερομηνία τελευταίας αναθεώρησης",},
...
keywords = { "GEMET INSPIRE Data Themes" : [
...
"Ecosystem and water quality assessment",
...
"Impacts of humans on water cycle",
...
"Land, river, coast and ocean management",
...
"Refining and transport operations",
...
"Bio-geographic Regions (Bio-geographic Regions)",
...
"Responsible Agency (Protected Sites)",
...
"Species Aggregation Unit (Species Distribution)",
...
"life-cycle information <spatial object>",

"life-cycle rules <spatial object>",
...
"metadata element - Resource language",
...
"metadata element - Temporal reference",

"metadata element - Topic category",

"metadata element - Unique resource identifier",
